<section>
    ...
    <!-- Change your form tag to look exactly like this -->
<form method="post" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <input id="company_logo" name="company_logo" type="file" class="mt-1 block w-full text-sm text-gray-500 border border-border rounded-md cursor-pointer focus:outline-none bg-white py-2 px-3" accept="image/*">
